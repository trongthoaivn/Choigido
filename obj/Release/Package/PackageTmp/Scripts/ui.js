...
const k = new pieces("k", "b", "/Content/Images/black_king.svg", "");
const q = new pieces("q", "b", "/Content/Images/black_queen.svg", "");
const b = new pieces("b", "b", "/Content/Images/black_bishop.svg", "");
const n = new pieces("n", "b", "/Content/Images/black_knight.svg", "");
const r = new pieces("r", "b", "/Content/Images/black_rook.svg", "");
const p = new pieces("p", "b", "/Content/Images/black_pawn.svg", "");
const K = new pieces("K", "w", "/Content/Images/white_king.svg", "");
const Q = new pieces("Q", "w", "/Content/Images/white_queen.svg", "");
const B = new pieces("B", "w", "/Content/Images/white_bishop.svg", "");
const N = new pieces("N", "w", "/Content/Images/white_knight.svg", "");
const R = new pieces("R", "w", "/Content/Images/white_rook.svg", "");
const P = new pieces("P", "w", "/Content/Images/white_pawn.svg", "");
